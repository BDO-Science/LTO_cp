...
saveRDS(turb_clean, "data_raw/turbidity_cdec_MAL_SJR_spring.rds")
...
```{r}
turb_clean <- readRDS("data_raw/turbidity_cdec_MAL_SJR_spring.rds")
...
### Plot data
```{r}
plot_turb <- ggplot2::ggplot(data=turbidity_f,aes(x=date2,y=mean,group=wy,color=wytype))+
  ggplot2::theme_bw()+
  ggplot2::geom_line(alpha=0.5)+
  facet_grid(station_name~wytype, scales = "free_y")+
...
### Save plot
```{r}
png(here("figures","turb_spring.png"),
     type="cairo",
     units="in", 
     width=8, #10*1, 
     height=7, #22*1, 
